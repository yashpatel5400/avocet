"""
Deterministic robust optimization with an Linf prediction region.
Minimize ||w||_2 subject to worst-case linear constraint <w, theta> <= 1
for all theta in an Linf ball (hypercube) around a point prediction.
"""
...
def main():
    ...
    radius = 0.2
    region = PredictionRegion.linf_ball(center=center, radius=radius)
